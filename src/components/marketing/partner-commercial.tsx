  ...
  return (
    <div>
      <ul className="mt-3 list-disc space-y-2 pl-5">
        ...
        <li>Aanmelden en je profiel zijn gratis, zonder lock-in. Na toelating (de Gate) beheer je in het portaal zelf je status (Actief of pauze) en je capaciteit.</li>
      </ul>
